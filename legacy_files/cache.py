...
class PersistentCache:
    ...
    def _evict_if_needed(self):
        ...
        to_evict = sorted_entries[:len(sorted_entries) // 10]  # 淘汰10%
    ...
    def cached(
        ...
        def decorator(func: Callable) -> Callable:
            ...
            def wrapper(*args, **kwargs):
                ...
                # 存入缓存
                self.set(cache_key, result, ttl=ttl, data_source=data_source)
...
def init_cache(**kwargs) -> PersistentCache:
    """初始化全局缓存"""
    global _global_cache
    _global_cache = PersistentCache(**kwargs)
    return _global_cache
